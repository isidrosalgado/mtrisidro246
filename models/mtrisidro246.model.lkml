...
datagroup: mtrisidro246_default_datagroup {
  # sql_trigger: SELECT MAX(id) FROM etl_log;;
  max_cache_age: "1 hour"
}

persist_with: mtrisidro246_default_datagroup
...
# To see the Explore you’re building, navigate to the Explore menu and select an Explore under "Mtrisidro246"
